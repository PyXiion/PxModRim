...
class UpdateManager(QObject):
    ...
    async def do_check_for_update(self) -> None:
        """
        ...
        try:
            ...
            update_info = await self._fetch_and_compare_versions()
            if not update_info:
    ...
    async def _fetch_and_compare_versions(self) -> Optional[dict[str, Any]]:
        """
        ...
        latest_release_info = await self._get_latest_release_info(needs_elevation)
    ...
    async def _get_latest_release_info(
